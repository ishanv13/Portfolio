    ...
    <footer className="bg-gray-900 text-white py-14">
      <div className="container mx-auto px-6 max-w-6xl">
        <div className="grid md:grid-cols-3 gap-10 mb-10">
          <div>
            <h2 className="text-2xl font-bold text-white mb-2">Ishan Verma</h2>
            <p className="text-gray-400 text-sm">Developer & Analyst</p>
          </div>

          <div className="flex gap-8 md:justify-center items-start pt-1">
